...
function getResourceEffortWarnings(
  tasks: ITask[],
...
export function GanttView() {
  ...
  const warningsByTask = useMemo(
    () => getResourceEffortWarnings(tasks, resourceList, calendarConfig, durationUnit),
    [calendarConfig, durationUnit, resourceList, tasks]
  )
